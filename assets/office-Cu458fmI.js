...
}`}}var Tr,Er,Dr,Or,kr=N((()=>{Tt(),Tr={core:{iTime:0,iResolution:new e.Vector2(1024,1024)},water:bt,grid:{...xt,uObjectStagger:0},dotaLogo:St,welcome:Ct},Er=(e,t,n,r=`vec2`)=>{let i=`varying ${r} ${n};`;e.vertexShader&&!e.vertexShader.includes(n+`;`)&&(e.vertexShader=e.vertexShader.replace(/void\s+main\s*\(\s*\)\s*\{/,e=>`${i}\n${e}`)),e.fragmentShader&&!e.fragmentShader.includes(n+`;`)&&(e.fragmentShader.includes(`#include <common>`)?e.fragmentShader=e.fragmentShader.replace(`#include <common>`,`#include <common>\n${i}`):e.fragmentShader=`${i}\n${e.fragmentShader}`)},Dr=(e,t,n)=>{let r=t===`vertex`?`vertexShader`:`fragmentShader`;e[r]&&!e[r].includes(n.trim())&&(e[r]=e[r].replace(/void\s+main\s*\(\s*\)\s*\{/,e=>`${e}\n    ${n}`))},Or=(e,t,n)=>{let r=Tr[n];if(r){n!==`core`&&Or(e,t,`core`);for(let[n,i]of Object.entries(r))e.uniforms[n]||(e.uniforms[n]=t[n]||{value:i})}}})),Ar,jr=N((()=>{Ar=`
    uniform vec2 iResolution;
    uniform float iTime;
    uniform float uBSODState; // 0.0 = Normal, 1.0 = BSOD
...
`||c*(r+5)>t?i+=n:i+=`ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789$#@%&*`[Math.floor(Math.random()*42)]}t.textContent=i}c<1?_s=requestAnimationFrame(o):t.textContent=e};_s=requestAnimationFrame(o)}}function ls(e=!1){if(_s&&cancelAnimationFrame(_s),fs||=document.getElementById(`stat-subtitle`),fs){if(fs.classList.remove(`active`),e){fs.innerHTML=``;return}setTimeout(()=>{fs.classList.contains(`active`)||(fs.innerHTML=``)},650)}}var us,ds,fs,ps,ms,hs,gs,_s,vs=N((()=>{as(),ps=0,ms=0,hs=0})),ys,bs=N((()=>{tt(),ys=class{constructor(e){this.canvas=document.getElementById(e),this.gl=this.canvas.getContext(`webgl2`,{alpha:!0,premultipliedAlpha:!0,antialias:!0}),this.gl||=(console.error(`WebGL2 not supported, falling back to WebGL1 (expect artifacts)`),this.canvas.getContext(`webgl`)),this.uProgress=0,this.targetProgress=0,this.mouse={x:.5,y:.5},this.gyro={beta:0,gamma:0},this.hasGyro=!1,this.pos={x:0,y:0},this.targetPos={x:0,y:0},this.velocity={x:0,y:0},this.bounds={top:-100,bottom:200,left:-200,right:200},this.isGlitching=!1,this.isInteractionStarted=!1,this.transformTarget=this.canvas,this.textures={poba:null,dev:null},this.init()}async init(){await this.loadTextures(),this.setupProgram(),this.onResize(),window.addEventListener(`resize`,()=>this.onResize());let e=!1;window.addEventListener(`mousemove`,t=>{!e&&!this.hasGyro&&(requestAnimationFrame(()=>{this.onMouseMove(t),e=!1}),e=!0)}),this.setupGyroListeners(),this.isVisible=!0,window.IntersectionObserver&&new IntersectionObserver(e=>{this.isVisible=e[0].isIntersecting},{threshold:.01}).observe(this.canvas),requestAnimationFrame(e=>this.render(e))}async loadTextures(){let e=e=>new Promise((t,n)=>{$e.transcoderPath||$e.setTranscoderPath(`https://cdn.jsdelivr.net/npm/three@0.170.0/examples/jsm/libs/basis/`),window._ktx2SupportDetected||($e.detectSupport({capabilities:{isWebGL2:!0},extensions:{has:e=>{try{return!!this.gl.getExtension(e)}catch{return!1}},get:e=>{try{return this.gl.getExtension(e)}catch{return null}}}}),window._ktx2SupportDetected=!0),$e.load(e,e=>{let n=this.gl,r=n.createTexture();n.bindTexture(n.TEXTURE_2D,r),e.mipmaps.forEach((t,r)=>{n.compressedTexImage2D(n.TEXTURE_2D,r,e.format,t.width,t.height,0,t.data)}),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_WRAP_S,n.CLAMP_TO_EDGE),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_WRAP_T,n.CLAMP_TO_EDGE),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_MIN_FILTER,e.mipmaps.length>1?n.LINEAR_MIPMAP_LINEAR:n.LINEAR),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_MAG_FILTER,n.LINEAR),t(r)},void 0,t=>{console.error(`Failed to load KTX2:`,e,t),n(t)})});this.textures.poba=await e(`./textures/ktx2/cv-poba-nobg.ktx2`),this.textures.dev=await e(`./textures/ktx2/cv-dev-nobg.ktx2`)}setupProgram(){this.program=this.createProgram(`#version 300 es
        ...
        `),this.locations={aPosition:this.gl.getAttribLocation(this.program,`aPosition`),uTime:this.gl.getUniformLocation(this.program,`uTime`),uResolution:this.gl.getUniformLocation(this.program,`uResolution`),uMouse:this.gl.getUniformLocation(this.program,`uMouse`),uProgress:this.gl.getUniformLocation(this.program,`uProgress`),uTexPoba:this.gl.getUniformLocation(this.program,`uTexPoba`),uTexDev:this.gl.getUniformLocation(this.program,`uTexDev`)};let e=this.gl.createBuffer();this.gl.bindBuffer(this.gl.ARRAY_BUFFER,e),this.gl.bufferData(this.gl.ARRAY_BUFFER,new Float32Array([-1,-1,1,-1,-1,1,1,1]),this.gl.STATIC_DRAW)}createProgram(e,t){let n=(e,t)=>{let n=this.gl.createShader(e);return this.gl.shaderSource(n,t),this.gl.compileShader(n),this.gl.getShaderParameter(n,this.gl.COMPILE_STATUS)||console.error(this.gl.getShaderInfoLog(n)),n},r=this.gl.createProgram();return this.gl.attachShader(r,n(this.gl.VERTEX_SHADER,e)),this.gl.attachShader(r,n(this.gl.FRAGMENT_SHADER,t)),this.gl.linkProgram(r),r}onMouseMove(e){this.mouse.x=e.clientX/window.innerWidth,this.mouse.y=1-e.clientY/window.innerHeight,this.hasGyro||(this.targetPos.x=(this.mouse.x-.5)*(this.boundary*.6),this.targetPos.y=(this.mouse.y-.5)*(this.boundary*.6))}setupGyroListeners(){let e=!1;window.addEventListener(`deviceorientation`,t=>{e||=(requestAnimationFrame(()=>{this.onDeviceOrientation(t),e=!1}),!0)},!0)}onDeviceOrientation(e){if(e.beta===null||e.gamma===null)return;this.hasGyro=!0;let t=.5+e.gamma/40*.5,n=.5-(e.beta-50)/40*.5;this.mouse.x=Math.max(0,Math.min(1,t)),this.mouse.y=Math.max(0,Math.min(1,n))}async requestGyroPermission(){if(typeof DeviceOrientationEvent<`u`&&typeof DeviceOrientationEvent.requestPermission==`function`)try{if(await DeviceOrientationEvent.requestPermission()===`granted`)return this.hasGyro=!0,this.isInteractionStarted=!0,!0}catch(e){console.error(`[AvatarEngine] Gyro Permission Cluster Error:`,e)}else return this.hasGyro=!0,this.isInteractionStarted=!0,!0;return!1}onResize(){this.canvas.width=this.canvas.clientWidth*window.devicePixelRatio,this.canvas.height=this.canvas.clientHeight*window.devicePixelRatio,this.gl.viewport(0,0,this.canvas.width,this.canvas.height)}render(e){if(requestAnimationFrame(e=>this.render(e)),v.update(e),!this.isVisible)return;let t=v.getAll().length>0?16.6:41.6;e-(this.lastTime||0)<t||(this.lastTime=e,this.gl.clear(this.gl.COLOR_BUFFER_BIT),this.gl.useProgram(this.program),this.gl.uniform1f(this.locations.uTime,e*.001),this.gl.uniform2f(this.locations.uResolution,this.canvas.width,this.canvas.height),this.gl.uniform4f(this.locations.uMouse,this.mouse.x,this.mouse.y,0,0),this.gl.uniform1f(this.locations.uProgress,this.uProgress),this.gl.activeTexture(this.gl.TEXTURE0),this.gl.bindTexture(this.gl.TEXTURE_2D,this.textures.poba),this.gl.uniform1i(this.locations.uTexPoba,0),this.gl.activeTexture(this.gl.TEXTURE1),this.gl.bindTexture(this.gl.TEXTURE_2D,this.textures.dev),this.gl.uniform1i(this.locations.uTexDev,1),this.updatePhysics(),this.gl.enableVertexAttribArray(this.locations.aPosition),this.gl.vertexAttribPointer(this.locations.aPosition,2,this.gl.FLOAT,!1,0,0),this.gl.drawArrays(this.gl.TRIANGLE_STRIP,0,4))}updatePhysics(){if(!this.isInteractionStarted)return;let e=performance.now()*.002,t=this.hasGyro?0:Math.sin(e*.7)*3,n=this.hasGyro?0:Math.cos(e*.5)*4,r=.15,i=this.mouse.x-.5,a=-(this.mouse.y-.5);i=Math.abs(i)<r?0:(i-Math.sign(i)*r)/(1-r),a=Math.abs(a)<r?0:(a-Math.sign(a)*r)/(1-r);let o=i*10,s=a*10;this.velocity.x+=o,this.velocity.y+=s;let c=.92;this.velocity.x*=c,this.velocity.y*=c,this.pos.x+=this.velocity.x+t,this.pos.y+=this.velocity.y+n;let l=!1;this.pos.x<this.bounds.left&&(this.pos.x=this.bounds.left,this.velocity.x*=-.5,l=!0),this.pos.x>this.bounds.right&&(this.pos.x=this.bounds.right,this.velocity.x*=-.5,l=!0),this.pos.y<this.bounds.top&&(this.pos.y=this.bounds.top,this.velocity.y*=-.5,l=!0),this.pos.y>this.bounds.bottom&&(this.pos.y=this.bounds.bottom,this.velocity.y*=-.5,l=!0),l&&!this.isGlitching&&this.triggerImpactGlitch(),this.transformTarget&&(this.transformTarget.style.transform=`translate3d(${this.pos.x}px, ${this.pos.y}px, 0)`)}triggerImpactGlitch(){this.isGlitching=!0;let e=this.uProgress,t=e>.5?.3:.7;new v.Tween(this).to({uProgress:t},50).repeat(3).yoyo(!0).onComplete(()=>{this.uProgress=e,setTimeout(()=>{this.isGlitching=!1},800)}).start(),typeof navigator.vibrate==`function`&&navigator.vibrate(15)}setProgress(e){this.uProgress=e}setTransformTarget(e){e&&(this.transformTarget=e)}setBounds(e){this.bounds={...this.bounds,...e}}transitionTo(e){new v.Tween(this).to({uProgress:e},1500).easing(v.Easing.Cubic.InOut).start()}}})),xs,Q,Ss=N((()=>{ge(),R(),ve(),vs(),Qo(),Zr(),bs(),xs=class{constructor(){this.currentMode=le,this.cvContent=document.getElementById(`cv-content`),this.personaPanel=document.getElementById(`protocol-selection-panel`),this.consoleEl=document.getElementById(`system-console-log`),this._lastSyncedMode=null,this.elements={role:document.getElementById(`cv-role`),summary:document.getElementById(`cv-summary`),summaryInner:document.querySelector(`.summary-content-inner`),experience:document.getElementById(`cv-experience`),skills:document.getElementById(`cv-skills`),modeBtns:document.querySelectorAll(`.mode-btn`),summaryModeBtns:document.querySelectorAll(`.mode-switch-btn`),systemTitle:document.querySelector(`.title-text`),timerDisplay:document.getElementById(`selection-timer`),dontAskCheckbox:document.getElementById(`dont-ask-persona`),avatarCubeWrapper:document.querySelector(`.avatar-cube-container`),avatarImgFront:document.getElementById(`cv-avatar-img-front`),avatarImgBack:document.getElementById(`cv-avatar-img-back`),contactsGroup:document.querySelector(`.contact-links-group`),portfolioTitle:document.getElementById(`portfolio-title`)},this.cachedSections=[],this.timerInterval=null,this.selectionPromiseResolver=null,this.pointsApp=null,this.summaryMode=`scan`,this.avatarEngine=new ys(`avatar-canvas`),this.init()}togglePersonaPanel(){if(!this.personaPanel&&(this.personaPanel=document.getElementById(`protocol-selection-panel`),!this.personaPanel))return;let e=window.getComputedStyle(this.personaPanel).display===`none`,t=document.getElementById(`persona-switch-btn`);if(e){if(t){let e=t.getBoundingClientRect(),n=e.left+e.width/2,r=e.top+e.height/2;this.personaPanel.style.transformOrigin=`${n}px ${r}px`}this.personaPanel.style.display=`flex`,this.personaPanel.classList.add(`minimizing`),this.personaPanel.offsetHeight,this.personaPanel.classList.remove(`minimizing`),this.startTimer(),window.scene&&(window.scene.isPersonaActive=!0)}else{if(t){let e=t.getBoundingClientRect(),n=e.left+e.width/2,r=e.top+e.height/2;this.personaPanel.style.transformOrigin=`${n}px ${r}px`}this.stopTimer(),this.personaPanel.classList.add(`minimizing`),this.personaPanel.classList.contains(`minimizing`)&&(setTimeout(()=>{this.selectionPromiseResolver&&=(this.selectionPromiseResolver(this.currentMode),null)},300),setTimeout(async()=>{if(this.personaPanel.style.display=`none`,window.scene&&(window.scene.isPersonaActive=!1),window.uiAnims&&window.uiAnims.triggerSpring&&window.uiAnims.triggerSpring(t),this.pointsApp&&typeof this.pointsApp.triggerEnergeticScrollJump==`function`){let e=typeof this.pointsApp.getCurrentStep==`function`?this.pointsApp.getCurrentStep():0;(e===0||e===1)&&this.pointsApp.triggerEnergeticScrollJump()}this.pointsApp&&typeof this.pointsApp.syncPersona==`function`&&this._lastSyncedMode!==this.currentMode&&(this.pointsApp.syncPersona(this.currentMode),this._lastSyncedMode=this.currentMode)},600))}}startTimer(){if(this.elements.timerBar||(this.elements.timerBar=document.getElementById(`selection-timer-bar`)),this.elements.timerNumber||(this.elements.timerNumber=document.getElementById(`timer-number`)),!this.elements.timerBar)return;this.elements.timerBar.style.transition=`none`,this.elements.timerBar.style.width=`100%`,this.elements.timerNumber&&(this.elements.timerNumber.innerText=`10`),this.elements.timerBar.offsetWidth,this.elements.timerBar.style.transition=`width 27s linear`,this.elements.timerBar.style.width=`0%`,this.stopTimer();let e=27;this.countInterval=setInterval(()=>{e--,e>=0&&this.elements.timerNumber&&(this.elements.timerNumber.innerText=e)},1e3),this.timerInterval=setTimeout(()=>{this.stopTimer(),this.setPersona(this.currentMode)},27e3)}stopTimer(){this.timerInterval&&=(clearTimeout(this.timerInterval),null),this.countInterval&&=(clearInterval(this.countInterval),null)}setPointsApp(e){this.pointsApp=e,this.currentMode&&typeof e.syncPersona==`function`&&(e.syncPersona(this.currentMode),this._lastSyncedMode=this.currentMode),this.syncUniform(this.currentMode)}async requestPersonaSelection(){return localStorage.getItem(`persona-skip-auto`)===`true`||this._modeFromUrl?this.currentMode:(this.togglePersonaPanel(),new Promise(e=>{this.selectionPromiseResolver=e}))}setPersona(e,t={}){this.stopTimer(),this.avatarEngine&&typeof this.avatarEngine.requestGyroPermission==`function`&&this.avatarEngine.requestGyroPermission(),he[e]&&(this.applyMode(e,!1,t.skipPointsSync),this.elements.dontAskCheckbox&&localStorage.setItem(`persona-skip-auto`,this.elements.dontAskCheckbox.checked),this.personaPanel&&this.personaPanel.style.display!==`none`&&this.togglePersonaPanel(),window.dispatchEvent(new CustomEvent(`personaSelected`,{detail:{mode:e}})))}init(){let e=new URLSearchParams(window.location.search).get(`mode`);e&&he[e]?(this.currentMode=e,this._modeFromUrl=!0,localStorage.setItem(`cv-view-mode-v3`,e)):(e=le,this.currentMode=e,this.updateUrl(e,!0),localStorage.setItem(`cv-view-mode-v3`,e)),this.applyMode(this.currentMode,!0),this.syncUniform(this.currentMode),this.elements.dontAskCheckbox&&(this.elements.dontAskCheckbox.checked=localStorage.getItem(`persona-skip-auto`)===`true`);let t=document.querySelector(`.header-photo`);t&&this.avatarEngine&&(this.avatarEngine.setTransformTarget(t),setTimeout(()=>{let e=t.getBoundingClientRect(),n=document.querySelector(`.scanline-deco`),r=document.querySelector(`.summary-header-wrapper`),i=document.querySelector(`.header-layout`);if(n&&r&&i){let t=n.getBoundingClientRect().bottom-e.top,a=r.getBoundingClientRect().top-e.top-80,o=i.getBoundingClientRect(),s=o.left-e.left,c=o.right-e.right;this.avatarEngine.setBounds({top:t,bottom:a,left:s,right:c})}},1e3)),this.setupEventListeners()}updateUrl(e,t=!1){let n=new URL(window.location);n.searchParams.get(`mode`)!==e&&(n.searchParams.set(`mode`,e),t?window.history.replaceState({mode:e},``,n):window.history.pushState({mode:e},``,n))}setupEventListeners(){let e=document.querySelector(`.header-photo`);e&&this.avatarEngine&&e.addEventListener(`click`,async()=>{await this.avatarEngine.requestGyroPermission()&&(e.style.transition=`filter 0.3s ease`,e.style.filter=`brightness(1.5) contrast(1.2)`,setTimeout(()=>{e.style.filter=``},300))},{once:!0}),document.addEventListener(`keydown`,e=>{if(!(e.target.tagName===`INPUT`||e.target.tagName===`TEXTAREA`)){if(e.key.toLowerCase()===`p`&&(e.preventDefault(),this.togglePersonaPanel()),e.key.toLowerCase()===`h`){e.preventDefault();let t=this.elements.portfolioTitle,n=document.querySelector(`.scroll-indicator`);if(t){let e=t.style.display===`none`?`block`:`none`;t.style.display=e,n&&(n.style.display=e)}}if(e.key.toLowerCase()===`b`){e.preventDefault();let t=document.getElementById(`board`);if(t){let e=t.style.display===`none`;t.style.display=e?``:`none`}}}});let t=document.getElementById(`cv-scroller`),n=document.querySelectorAll(`.nav-item`);if(t){let e=!1,r=()=>{if(window._cvState&&window._cvState!==`idle`){e=!1;return}let r=``,i=t.scrollTop;for(let e=0;e<this.cachedSections.length;e++){let t=this.cachedSections[e];i>=t.offsetTop-120&&(r=t.id||t.getAttribute(`id`))}n.forEach(e=>{e.classList.toggle(`active`,e.getAttribute(`data-target`)===r)}),i<100&&(n.forEach(e=>e.classList.remove(`active`)),n.length>0&&n[0].classList.add(`active`)),e=!1};t.addEventListener(`scroll`,()=>{e||=(requestAnimationFrame(r),!0)},{passive:!0}),this.cacheScrollSections()}this.personaPanel&&this.personaPanel.addEventListener(`click`,e=>{e.target===this.personaPanel&&this.togglePersonaPanel()}),window.addEventListener(`popstate`,e=>{let t=e.state&&e.state.mode||new URLSearchParams(window.location.search).get(`mode`)||le;t!==this.currentMode&&this.applyMode(t,!1)}),this.elements.summaryModeBtns&&this.elements.summaryModeBtns.forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation();let n=e.getAttribute(`data-summary-mode`);this.summaryMode!==n&&(this.summaryMode=n,this.elements.summaryModeBtns.forEach(e=>e.classList.remove(`active`)),e.classList.add(`active`),this.renderSummary())})});let r=document.getElementById(`dismiss-3d-hint`);r&&r.addEventListener(`click`,e=>{e.stopPropagation();let t=document.querySelector(`.mobile-3d-hint`);t&&t.classList.add(`hidden`)})}applyMode(e,t=!1,n=!1){let r=this.currentMode===e,i=this.pointsApp&&typeof this.pointsApp.isMorphing==`function`?this.pointsApp.isMorphing():!1;if(this.currentMode=e,localStorage.setItem(`cv-view-mode-v3`,e),document.querySelectorAll(`[data-mode]`).forEach(t=>{let n=t.getAttribute(`data-mode`),r=t.querySelector(`.preference-hint`);n===e?(t.classList.add(`active`),localStorage.getItem(`cv-view-mode-v3`)&&r&&(r.innerText=`YOUR PREVIOUS SELECTION`,r.style.display=`block`)):(t.classList.remove(`active`),r&&(r.style.display=`none`))}),r&&!i&&!t)return;if(t)this.updateDOM();else{if(this.avatarEngine){let e=this.currentMode===`dev`?1:0;this.avatarEngine.transitionTo(e)}this.cvContent?(this.cvContent.classList.add(`swapping`),setTimeout(()=>{this.updateDOM(),this.cvContent.classList.remove(`swapping`)},300)):this.updateDOM()}if(window.dispatchEvent(new CustomEvent(`audienceChanged`,{detail:{mode:e}})),window.scene&&window.scene.scenarioState?.name===`room`&&!t&&!window.scene.isHeroAnimating){let t=z(e===I.POBA?`SYS_DRONE_SUBTITLES_POBA`:`SYS_DRONE_SUBTITLES_DEV`);cs(t),Fo(window.scene,null,t)}this.syncUniform(e),Lr(e===I.POBA);let a=this.personaPanel&&this.personaPanel.style.display!==`none`;this.pointsApp&&typeof this.pointsApp.syncPersona==`function`&&!a&&(this._lastSyncedMode!==e||i)&&(this.pointsApp.syncPersona(e,n),this._lastSyncedMode=e),t||this.updateUrl(e);let o=he[e];o&&o.systemTitle&&(document.title=`${o.systemTitle} | BUI QUOC HIEU Portfolio`)}syncUniform(e){if(window.scene&&window.scene.globalUniformsHub&&window.scene.globalUniformsHub.displaySystem){let t=e===I.POBA?1:0;window.scene.globalUniformsHub.displaySystem.uIsPoba.value=t}}triggerCyberDecode(e,t,n=1500){if(!e||!t)return;e.scrambleRaf&&cancelAnimationFrame(e.scrambleRaf);let r=t.length,i=performance.now(),a=i,o=s=>{s||=performance.now();let c=s-i,l=Math.min(c/n,1);if(s-a>41.666666666666664||l===1){a=s;let n=``;for(let e=0;e<r;e++){let i=t[e];i===` `||i===`
