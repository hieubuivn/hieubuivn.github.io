import*as e from"three";import{AdditiveBlending as t,Box2 as n,BufferGeometry as r,Color as i,FramebufferTexture as a,InterleavedBuffer as o,InterleavedBufferAttribute as s,Mesh as c,MeshBasicMaterial as l,RawShaderMaterial as u,ShaderMaterial as d,UniformsUtils as f,UnsignedByteType as p,Vector2 as m,Vector3 as h,Vector4 as g,WebGLRenderTarget as _}from"three";import"three/addons/libs/stats.module.js";import v from"tween";import*as y from"rapier-compat";import b from"rapier-compat";import{GLTFLoader as x}from"three/addons/loaders/GLTFLoader.js";import{RGBELoader as S}from"three/addons/loaders/RGBELoader.js";import{DRACOLoader as C}from"three/addons/loaders/DRACOLoader.js";import{KTX2Loader as w}from"three/addons/loaders/KTX2Loader.js";import{OrbitControls as T}from"three/addons/controls/OrbitControls.js";import{EffectComposer as E}from"three/addons/postprocessing/EffectComposer.js";import{RenderPass as D}from"three/addons/postprocessing/RenderPass.js";import*as O from"three/addons/utils/SkeletonUtils.js";import{FullScreenQuad as k,Pass as A}from"three/addons/postprocessing/Pass.js";import{CopyShader as j}from"three/addons/shaders/CopyShader.js";import{LuminosityHighPassShader as M}from"three/addons/shaders/LuminosityHighPassShader.js";var N=Object.defineProperty,P=(e,t)=>()=>(e&&(t=e(e=0)),t),ee=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports),te=(e,t)=>{let n={};for(var r in e)N(n,r,{get:e[r],enumerable:!0});return t||N(n,Symbol.toStringTag,{value:`Module`}),n};function ne(e=1,t=1,n=document){let r=n===document?document.getElementById(`board`):n.querySelector(`#board`),i=n.querySelector(`.intro-main-name1`),a=n.querySelector(`.intro-main-name2`),o=n.querySelector(`.intro-sub`),s=n.querySelector(`.board-philo-sub`),c=n.querySelector(`.board-philo-main`),l=n.getElementById?n.getElementById(`board-feat-1`):n.querySelector(`#board-feat-1`),u=n.getElementById?n.getElementById(`board-feat-2`):n.querySelector(`#board-feat-2`);if(!r||!i||!a||!o)return;let d=r.clientWidth;if(d<=1)return;t=Math.max(0,Math.min(1,t===void 0?window.__boardSubProgress??1:t));let f=4.2*e;r.style.gap=f+`vh`;let p=getComputedStyle(i).fontFamily,m=F(`BUI QUOC`,`20px ${p}`),h=F(`VISION BECOMES`,`20px ${p}`),g=20*(d/Math.max(10,h+(m-h)*t))*e,_=F(i.innerText,`${g}px ${p}`);_>d&&_>.01&&(g*=d/_),i.style.fontSize=g+`px`,a.style.fontSize=g+`px`;let v=n.getElementById?n.getElementById(`board-intro`):n.querySelector(`#board-intro`);if(t<=0?(o.style.display=`none`,o.style.fontSize=`0px`,o.style.lineHeight=`0`,v&&(v.style.gap=`0vh`)):(o.style.display=`block`,o.style.fontSize=g*.3*t+`px`,o.style.lineHeight=t,v&&(v.style.gap=.75*t+`vh`)),c){let i=getComputedStyle(c).fontFamily,a=F(`PI-SHAPED ENGINEERING & STRATEGY`,`20px ${i}`),o=F(`ALIGNED THROUGH ENGINEERING`,`20px ${i}`),f=20*(d/Math.max(10,o+(a-o)*t))*e,p=F(c.innerText,`${f}px ${i}`);p>d&&p>.01&&(f*=d/p),c.style.fontSize=f+`px`;let m=n.getElementById?n.getElementById(`board-philo`):n.querySelector(`#board-philo`);if(s){if(t<=0)s.style.display=`none`,s.style.fontSize=`0px`,s.style.lineHeight=`0`,m&&(m.style.gap=`0vh`);else{s.style.display=`block`;let e=f*.8*t;s.style.fontSize=e+`px`,s.style.lineHeight=t,m&&(m.style.gap=.75*t+`vh`)}let e=n.getElementById?n.getElementById(`board-feat`):n.querySelector(`#board-feat`),i=f*.48,a=getComputedStyle(l||r).fontFamily;if(e&&e.style.setProperty(`--feat-border-scale`,t),u&&(t<=0?(u.style.display=`none`,u.style.fontSize=`0px`,u.style.lineHeight=`0`,e&&(e.style.gap=`0vh`)):(u.style.display=`block`,u.style.fontSize=i*t+`px`,u.style.lineHeight=t,e&&(e.style.gap=.5*t+`vh`))),l){l.style.paddingTop=2.75*t+`vh`;let e=F(`3+ YEARS • INTERACTIVE UX • AR/VR/3D`,`20px ${a}`),n=F(`π-shaped lead.Strategy in motion.`,`20px ${a}`),r=Math.max(10,n+(e-n)*t),o=d/r*20,s=i/o*o;s=i;let c=F(l.innerText,`${s}px ${a}`);c>d&&c>.01&&(s*=d/c),l.style.fontSize=s+`px`;let f=33+3*t,p=(d-s/20*r)/(f-1),m=s*.25,h=Math.max(0,Math.min(m,p));l.style.letterSpacing=h+`px`,u&&t>0&&(u.style.letterSpacing=h+`px`)}}}}function re(){let e=document.getElementById(`board`);e&&(window.fitBoardTexts=ne,new ResizeObserver(()=>{let e=window.__boardScale||1,t=window.__boardSubProgress??1;requestAnimationFrame(()=>ne(e,t))}).observe(e),document.fonts&&document.fonts.ready.then(()=>{let e=window.__boardScale||1,t=window.__boardSubProgress??1;requestAnimationFrame(()=>ne(e,t))}),ne(window.__boardScale||1,window.__boardSubProgress??1))}var ie,F,ae=P((()=>{ie={chaos:{bottom:12,top:0,scale:1,subVisible:!0,philoSubVisible:!0,mode:`mode-chaos`},root:{bottom:0,top:12,scale:.8,subVisible:!1,philoSubVisible:!1,mode:`mode-root`},dance:{bottom:0,top:16,scale:.8,subVisible:!1,philoSubVisible:!1,mode:`mode-dance`},walk:{bottom:12,top:0,scale:.8,subVisible:!1,philoSubVisible:!1,mode:`mode-walk`}},F=(e,t)=>(F.canvas||(F.canvas=document.createElement(`canvas`),F.context=F.canvas.getContext(`2d`)),F.context.font=t,F.context.measureText(e).width)})),I,oe=P((()=>{I={SYS_INIT:{en:[`REASONING THROUGH 1T LOGIC TOKENS...`,`MATERIALIZING CLAUDE-INSPIRED ARTIFACTS...`,`THINKING: DEEPSEEK-ING OPTIMAL ANCHORS...`,`LOADING LATENT SPACE WEIGHTS...`]},SYS_INITIALIZING_SYSTEM:{en:[`O1 MODULE THINKING: VERIFYING INTEGRITY...`,`PROMPTING THE CORE FOR MULTI-MODAL SYNTHESIS...`,`REASONING: QUANTIZING LOGIC FOR PRESTIGE...`,`INITIALIZING SYSTEM: STABILIZING CONTEXT...`]},SYS_POINTS_INIT:{en:[`TRACING VOXEL ARTIFACTS ACROSS THE GRID...`,`REASONING THROUGH QUANTUM POINT-CLOUD DENSITY...`,`LOADING: TOKENIZING SPATIAL NEBULAS...`,`THINKING: MAPPING THE LATENT GEOMETRY...`]},SYS_MODEL_ASSEMBLY:{en:[`H100 GPU CLOCK: ASSEMBLING MESH ARTIFACTS...`,`FINE-TUNING MODEL WEIGHTS FOR AESTHETIC PEAK...`,`GPT-4O VISION THINKING: ALIGNING GEOMETRY...`,`REASONING: SYNCING HOLOGRAPHIC TOKENS...`]},SYS_PHYSICS_BINDING:{en:[`ENFORCING AGENTIC KINETIC CONSTRAINTS...`,`REASONING: BAKING PHYSICS INTO TOKEN FABRIC...`,`THINKING: SOLVING ENTROPY PARADOXES...`,`LOADING KINETIC ARTIFACTS: LOCKING MATRICES...`]},SYS_TEXTURE_LOAD:{en:[`THINKING: DECODING VISUAL BUFFER TOKENS...`,`STREAMING BITMAP ARTIFACTS FROM THE CLOUD...`,`REASONING: HYDRATING PIXEL ARRAYS...`,`LOADING: REFINING SHADER DIFFUSION WEIGHTS...`]},SYS_ERROR:{en:[`CRITICAL NEURAL BREACH DETECTED`,`SYNAPTIC COLLAPSE: RE-PROMPTING...`,`LOGIC LOOP TERMINATED BY AGENT`,`CORE INTEGRITY VOID: FATAL`]},SYS_INIT_SCENE:{en:[`REASONING: CONSTRUCTING THE PERCEPTIVE PLANE...`,`THINKING: SYNTHESIZING AGENT-READY ENVIRONMENT...`,`LOADING VIRTUAL GRID ARTIFACTS...`,`ALIGNING RENDER CONTEXT TOKENS...`]},SYS_FINALIZE:{en:[`THINKING: SEALING COGNITIVE LOOPS...`,`REASONING: FINALIZING NEURAL SYNC ARTIFACTS...`,`LOADING: BOOTSTRAPPING CONSCIOUSNESS...`,`EXECUTING FINAL HANDSHAKE TOKENS...`]},SYS_RETRIEVING_ASSETS:{en:[`LOADING: HARVESTING REMOTE DATA NODES...`,`REASONING: DOWNLOADING CORE ARTIFACTS...`,`THINKING: PULLING SECTOR BINARY TOKENS...`,`RETRIEVING ENCRYPTED ASSEST WEIGHTS...`]},SYS_HEAVY_SHADERS:{en:[`H100 OVERLOAD: OPTIMIZING SHADER PIPELINES...`,`THINKING: COMPILING NEURAL GLSL TOKENS...`,`REASONING: THROTTLING PIXEL DENSITY...`,`RECLAIMING LATENT MEMORY ARTIFACTS...`]},SYS_PHYSICS_CALC:{en:[`REASONING: SOLVING SPATIAL PARADOXES...`,`THINKING: CALCULATING KINETIC TOKENS...`,`LOADING GRAVITY VORTEX ARTIFACTS...`,`POLLING AGENTIC COLLISION SENSORS...`]},SYS_MAPPING_BOUNDARIES:{en:[`THINKING: DEFINING SPATIAL PERIMETERS...`,`REASONING: MAPPING KINETIC TOKENS...`,`LOADING: LOCKING PERIMETER ARTIFACTS...`,`TRACING COLLISION VOLUME WEIGHTS...`]},SYS_CHAR_COLLISION:{en:[`THINKING: ALIGNING NEURAL AVATAR...`,`REASONING: SYNCHRONIZING BONE TOKENS...`,`LOADING: CALIBRATING KINEMATIC ARTIFACTS...`,`STABILIZING SKELETAL RIG WEIGHTS...`]},SYS_BINDING_ARMATURES:{en:[`THINKING: WIRING NEURAL ARMATURES...`,`REASONING: LINKING JOINT TOKENS...`,`LOADING: VALIDATING KINETIC ARTIFACTS...`,`SECURING BONE HIERARCHY WEIGHTS...`]},SYS_ANCHORING_ROTORS:{en:[`THINKING: STABILIZING CYCLICAL LOGIC...`,`REASONING: ANCHORING ROTATIONAL TOKENS...`,`LOADING: FLUX CAPACITANCE Artifact...`,`SYNCHRONIZING FAN CYCLE ARTIFACTS...`]},SYS_DYNAMIC_RIGIDBODIES:{en:[`THINKING: SOLVING ENTROPY ALIGNMENT...`,`REASONING: CALCULATING KINETIC CHAOS TOKENS...`,`LOADING: POLLING DYNAMIC ARTIFACTS...`,`STABILIZING PHYSICS ENTROPY WEIGHTS...`]},SYS_BONE_HIERARCHIES:{en:[`THINKING: RECURSING SKELETAL ARTIFACTS...`,`REASONING: VALIDATING JOINT TOKENS...`,`LOADING: TRACING BONE TOPOLOGY...`,`SCANNING VERTEBRAL DATA WEIGHTS...`]},SYS_COLLISION_MESHES:{en:[`THINKING: REGISTERING SPATIAL ARTIFACTS...`,`REASONING: COMMITTING PHYSICS TOKENS...`,`LOADING: SEALING COLLISION VOLUMES...`,`WRAPPING KINETIC SHELL WEIGHTS...`]},SYS_CALIBRATING_POINTS:{en:[`THINKING: ALIGNING QUANTUM PARTICLES...`,`REASONING: SOLVING NEURAL TOKENS...`,`LOADING: INTERPRETING DATA ARTIFACTS...`,`CALIBRATING VOXEL VECTOR WEIGHTS...`]},SYS_INIT_MODELS:{en:[`THINKING: MATERIALIZING SECTOR ARTIFACTS...`,`REASONING: ASSEMBLING CRYSTALLINE TOKENS...`,`LOADING: SYNTHESIZING MESH WEIGHTS...`,`UPLOADING VOLUMETRIC MATRICES...`]},SYS_WARMING_ENGINES:{en:[`THINKING: PRIMING SYNAPTIC TOKENS...`,`REASONING: SYNCHRONIZING GPU ARTIFACTS...`,`LOADING: EXECUTING NEURAL BOOT SEQUENCE...`,`WARMING QUANTUM SHADER WEIGHTS...`]},SYS_CONFIG_MATERIALS:{en:[`THINKING: OPTIMIZING PIXEL SHADERS...`,`REASONING: REFINING LIGHT-FIELD TOKENS...`,`LOADING: POLISHING SURFACE ARTIFACTS...`,`CONFIGURING GPU MATRIX WEIGHTS...`]},SYS_READY:{en:[`SIMULATING AGI COMPLETE: SYSTEM NOMINAL.`,`REASONING TOKENS DEPLETED. SYSTEM READY.`,`ARTIFACT LOAD SUCCESSFUL. STANDING BY.`,`THINKING FINISHED. PRESTIGE MODE ACTIVE.`]},NARR_STEP_0_PREFIX_DEV:{en:[`HELLO, I AM`]},NARR_STEP_0_HEADER_DEV:{en:[`BUI QUOC
...
10+ YEARS • PRODUCT STRATEGY • FINTECH/IOT/EV`]},NARR_STEP_0_PREFIX_POBA:{en:[`HELLO, I AM`]},NARR_STEP_0_HEADER_POBA:{en:[`BUI QUOC
HIEU`]},NARR_STEP_0_VERB_POBA:{en:[`PI-SHAPED STRATEGY & ENGINEERING`]},NARR_STEP_0_OUTCOME_POBA:{en:[`WHERE STRATEGY MEETS EXECUTION.`]},NARR_STEP_0_CREDIBILITY_POBA:{en:[`10+ YEARS • PRODUCT STRATEGY • FINTECH/IOT/EV 
...
`,$t=Dt(`#FBC189`,1,1),$t.name=`goldInner`,$t.clone(),en=Et(`#FBC189`,1,.01,6.5,e.FrontSide),en.name=`goldOuter`,tn=`
// Simplex 3D Noise 
...
`,rn=At(`#FBC189`,1,1,1),Mt(`#FBC189`,1,1,1),an=jt(`#FBC189`,1,.01,6.5,e.FrontSide,1),Nt(`#FBC189`,1,.01,6.5,e.FrontSide,1),on=Ft(`#FBC189`,1,1,.1),sn=`
    uniform vec2 iResolution;
    uniform float iTime;
    uniform vec2 uMouse;
    uniform vec2 uSmoothedMouse;
...
`+e.fragmentShader,Dr(e,`fragment`,`
    ...
    `),e.fragmentShader=e.fragmentShader.replace(/UV\s*=\s*vUv/g,`UV = vWarpedUv`).replace(/texture2D\(\s*map\s*,\s*vMapUv\s*\)/g,`texture2D( map, vWarpedUv )`).replace(/texture2D\(\s*roughnessMap\s*,\s*vMapUv\s*\)/g,`texture2D( roughnessMap, vWarpedUv )`).replace(/texture2D\(\s*metalnessMap\s*,\s*vMapUv\s*\)/g,`texture2D( metalnessMap, vWarpedUv )`).replace(/texture2D\(\s*bumpMap\s*,\s*vMapUv\s*\)/g,`texture2D( bumpMap, vWarpedUv )`).replace(/texture2D\(\s*iChannel([0-9X])\s*,\s*(vUv|uv)\s*\)/g,`texture2D( iChannel$1, vWarpedUv )`).replace(/textureLod\(\s*iChannelX\s*,\s*UV\+n\s*,\s*focus\s*\)/g,`textureLod( iChannelX, vWarpedUv+n, focus )`).replace(/texture2D\(\s*fireFliesTexture\s*,\s*uv\s*\)/g,`texture2D( fireFliesTexture, vWarpedUv )`),e.fragmentShader.includes(`#include <normal_fragment_begin>`)&&(e.fragmentShader=e.fragmentShader.replace(`#include <normal_fragment_begin>`,`
            ...
            `))}function Cr(e,t={}){if(Or(e,t,`grid`),Er(e,`vertex`,`vPatchedUv`,`vec2`),Er(e,`vertex`,`vWorldPos`,`vec3`),Dr(e,`vertex`,`vPatchedUv = uv;`),Dr(e,`vertex`,`vWorldPos = (modelMatrix * vec4(position, 1.0)).xyz;`),e.fragmentShader.includes(`Holographic Grid Overlay`))return;let n=`
        ${e.fragmentShader.includes(`uniform float iTime;`)?``:`uniform float iTime;`}
...
}`}}function wr(e,t={}){if(Or(e,t,`welcome`),Er(e,`vertex`,`vPatchedUv`,`vec2`),Dr(e,`vertex`,`vPatchedUv = uv;`),e.fragmentShader.includes(`Welcome Text Header`))return;let n=e.fragmentShader.includes(`uniform float iTime;`),r=e.fragmentShader.includes(`uniform vec2 iResolution;`),i=`
        // --- Welcome Text Header ---
...
}`}}var Tr,Er,Dr,Or,kr=P((()=>{Tt(),Tr={core:{iTime:0,iResolution:new e.Vector2(1024,1024)},water:bt,grid:{...xt,uObjectStagger:0},dotaLogo:St,welcome:Ct},Er=(e,t,n,r=`vec2`)=>{let i=`varying ${r} ${n};`;e.vertexShader&&!e.vertexShader.includes(n+`;`)&&(e.vertexShader=e.vertexShader.replace(/void\s+main\s*\(\s*\)\s*\{/,e=>`${i}\n${e}`)),e.fragmentShader&&!e.fragmentShader.includes(n+`;`)&&(e.fragmentShader.includes(`#include <common>`)?e.fragmentShader=e.fragmentShader.replace(`#include <common>`,`#include <common>\n${i}`):e.fragmentShader=`${i}\n${e.fragmentShader}`)},Dr=(e,t,n)=>{let r=t===`vertex`?`vertexShader`:`fragmentShader`;e[r]&&!e[r].includes(n.trim())&&(e[r]=e[r].replace(/void\s+main\s*\(\s*\)\s*\{/,e=>`${e}\n    ${n}`))},Or=(e,t,n)=>{let r=Tr[n];if(r){n!==`core`&&Or(e,t,`core`);for(let[n,i]of Object.entries(r))e.uniforms[n]||(e.uniforms[n]=t[n]||{value:i})}}})),Ar,jr=P((()=>{Ar=`
    uniform vec2 iResolution;
    uniform float iTime;
    uniform float uBSODState; // 0.0 = Normal, 1.0 = BSOD
...
`).replace(/,$/,``)}\n}`):i=e.summary,this.elements.summaryInner.innerHTML=`
        ...
        `,this.elements.summaryInner.querySelectorAll(`.mode-switch-btn`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation();let n=e.getAttribute(`data-summary-mode`);this.summaryMode!==n&&(this.summaryMode=n,this.renderSummary())})});let a=this.elements.summaryInner.querySelector(`.copy-code-btn`);if(a&&a.addEventListener(`click`,e=>{e.stopPropagation(),navigator.clipboard.writeText(i).then(()=>{let e=a.querySelector(`.btn-txt`);if(e){let t=e.innerText;e.innerText=`COPIED!`,a.classList.add(`copied`),setTimeout(()=>{e.innerText=t,a.classList.remove(`copied`)},2e3)}})}),t)this.elements.summaryInner.querySelectorAll(`.code-key, .code-val`).forEach((e,t)=>{let n=e.getAttribute(`data-target-text`);this.triggerCyberDecode(e,n,1e3+t*100)});else{let t=this.elements.summaryInner.querySelector(`.summary-narrative`);t&&this.triggerCyberDecode(t,e.summary,1200)}}updateDOM(){let e=he[this.currentMode];if(e){if(this.elements.role&&this.triggerCyberDecode(this.elements.role,e.role,Math.max(1e3,e.role.length*40)),this.elements.systemTitle&&e.systemTitle&&this.triggerCyberDecode(this.elements.systemTitle,e.systemTitle,1e3),this.renderSummary(),this.elements.experience&&(this.elements.experience.innerHTML=e.experience.map(e=>`
            ...
            `).join(``),this.rebindCollapsibles()),this.pointsApp&&typeof this.pointsApp.refreshUIPersonaSync==`function`)this.pointsApp.refreshUIPersonaSync();else if(this.elements.portfolioTitle){let e=this.pointsApp&&typeof this.pointsApp.getCurrentStep==`function`?this.pointsApp.getCurrentStep():0,t=this.currentMode.toUpperCase(),n=this.elements.portfolioTitle.querySelector(`.title-prefix`),r=this.elements.portfolioTitle.querySelector(`.title-header`);n&&(n.innerText=z(`NARR_STEP_0_PREFIX_${t}`)),r&&(r.innerText=z(`NARR_STEP_0_HEADER_${t}`));let i=this.elements.portfolioTitle.querySelector(`.title-verb`),a=this.elements.portfolioTitle.querySelector(`.title-outcome`),o=this.elements.portfolioTitle.querySelector(`.title-credibility`);i&&(i.innerText=z(`NARR_STEP_0_VERB_${t}`)),a&&(a.innerText=z(`NARR_STEP_0_OUTCOME_${t}`)),o&&(o.innerText=z(`NARR_STEP_0_CREDIBILITY_${t}`));let s=this.elements.portfolioTitle.querySelector(`.title-subtitle`);s&&(s.innerText=z(`NARR_STEP_${e}_SUBTITLE_${t}`))}if(this.elements.skills&&(this.elements.skills.classList.remove(`skills-grid`),this.elements.skills.innerHTML=e.skills.map(e=>`
    ...
    `,fragmentShader:js(),transparent:!0,uniforms:a,blending:e.NormalBlending,depthTest:!1,depthWrite:!1,side:e.FrontSide}),s=new e.Mesh(r,o);s.name=`HUDFrame`,s.frustumCulled=!1,s.renderOrder=9999,s.isOpen=!1,t.HUD=s,i();let c=(e,t,n,r,i,a,o)=>{let s=r,c=-n,l=t-s,u=-(e-c),d=-(t-(r-i)),f=(e-(c+o))*-.7071+(t-s)*.7071,p=(e-(c+a))*.7071+(t-s)*-.7071;return Math.max(Math.max(Math.max(Math.max(l,u),d),p),f)},l=performance.now(),u=0,d=[new e.Vector2,new e.Vector2],f={pos:new e.Vector2(0,0),vel:new e.Vector2(0,0),rot:0,angVel:0,isActive:!1,shouldSnapToAnchor:!0,mass:1,getMOI:e=>1/12*1*(e*2)**2},p={pos:new e.Vector2(0,0),vel:new e.Vector2(0,0),rot:0,angVel:0,isActive:!1,shouldSnapToAnchor:!0,mass:2,getMOI:(e,t)=>1/12*2*(e*e+t*t)},m={pos:new e.Vector2(0,0),vel:new e.Vector2(0,0),rot:0,angVel:0,isActive:!1,shouldSnapToAnchor:!0,mass:1.5,getMOI:(e,t)=>1/12*1.5*(e*e+t*t)},h={pos:new e.Vector2(0,0),vel:new e.Vector2(0,0),rot:0,angVel:0,isActive:!1,shouldSnapToAnchor:!0,mass:1.5,getMOI:(e,t)=>1/12*1.5*(e*e+t*t)};s.applyBeamImpulse=()=>{f.isActive=!0,f.shouldSnapToAnchor=!1;let n=t.width||window.innerWidth,r=t.height||window.innerHeight,i=r*a.uMarginPct.value,o=r*(a.uMarginPct.value+a.uVerticalMarginPct.value),s=new e.Vector2((n-i*2)*.5,(r-o*2)*.5),c=s.x*2,l=s.y*2;f.pos.lengthSq()<.001&&f.pos.set(s.x,0);let u=a.uBNotchHRatio.value,d=a.uBNotchWRatio.value,p=-s.y+l*u,g=l*u*.57735*2,_=c*d-g,y=a.uBNotchBarProgress.value,b=new e.Vector2(-_*.5+y*_,p),x=a.uRNotchHRatio.value,S=s.y*2*x*.8*.5,C=a.uBeamAttachRatio.value,w=new e.Vector2(s.x,e.MathUtils.mapLinear(C,0,1,-S,S)),T=new e.Vector2().subVectors(w,b).normalize().multiplyScalar(2800),E=new e.Vector2().subVectors(w,f.pos);f.vel.add(T.clone().divideScalar(f.mass));let D=E.x*T.y-E.y*T.x;f.angVel+=D/f.getMOI(S),new v.Tween(a.uRNotchBarThickness).to({value:.002},300).easing(v.Easing.Back.Out).start(),setTimeout(()=>{m.isActive=!0,m.shouldSnapToAnchor=!1,m.vel.set(-100+Math.random()*-200,-100),m.angVel=(Math.random()-.5)*5,h.isActive=!0,h.shouldSnapToAnchor=!1,h.vel.set(-150+Math.random()*-200,-50),h.angVel=(Math.random()-.5)*5},100)},s.resetBarPhysics=()=>{f.isActive=!1,f.shouldSnapToAnchor=!0,f.pos.set(0,0),f.vel.set(0,0),f.rot=0,f.angVel=0,p.isActive=!1,p.pos.set(0,0),p.vel.set(0,0),p.rot=0,p.angVel=0,m.isActive=!1,m.pos.set(0,0),m.vel.set(0,0),m.rot=0,m.angVel=0,h.isActive=!1,h.pos.set(0,0),h.vel.set(0,0),h.rot=0,h.angVel=0};let g=performance.now();s.onBeforeRender=()=>{!a.uSpriteSheet.value&&H.spriteSheet&&(a.uSpriteSheet.value=H.spriteSheet);let n=performance.now(),r=Math.min(.032,(n-g)/1e3);g=n;let o=a.iTime.value,c=t.width||window.innerWidth,v=t.height||window.innerHeight,y=v*a.uMarginPct.value,b=v*(a.uMarginPct.value+a.uVerticalMarginPct.value),x=(c-y*2)*.5,S=(v-b*2)*.5;if(u++,n>l+1e3){Math.round(u*1e3/(n-l)),l=n,u=0;let e=c-y*2-$.CUT_SIZE*2;e*$.ISL_TO_MAIN_WRatio_NOT_FOUND||e*$.ISL_TO_MAIN_W_RATIO;let t=v-b*2;t*$.ISL_BAR_HEIGHT_RATIO,t*$.ISL_BAR_GAP_RATIO,t*$.ISL_BAR_MARGIN_Y_RATIO;let r=t*($.ISL_BAR_MARGIN_Y_RATIO*2+2*$.ISL_BAR_HEIGHT_RATIO+1*$.ISL_BAR_GAP_RATIO);$.CUT_SIZE+r-$.CORNER_RADIUS}let C=v*a.uMarginPct.value;v*(a.uMarginPct.value+a.uVerticalMarginPct.value);let w=(c-C*2)*.5;f.shouldSnapToAnchor&&f.pos.set(w,0);let T=S*2*a.uBNotchHRatio.value,E=-S+T;if(p.shouldSnapToAnchor&&p.pos.set(0,E),a.uRBarRot.value=f.rot,a.uRBarPos.value.copy(f.pos),a.uBBarRot.value=p.rot,a.uBBarPos.value.copy(p.pos),f.isActive||p.isActive||m.isActive||h.isActive){let e=-1200,t=.6,n=S*a.uRNotchHRatio.value*.8;if(f.isActive){f.vel.y+=e*r,f.pos.addScaledVector(f.vel,r),f.rot+=f.angVel*r,f.vel.multiplyScalar(.99),f.angVel*=.98;let i=-v*.5+5,o=c*.5-5;d[0].set(0,n),d[1].set(0,-n);let s=d;for(let e of s){let n=Math.sin(f.rot),r=Math.cos(f.rot),s=e.x*r-e.y*n,c=e.x*n+e.y*r,l=f.pos.x+s,u=f.pos.y+c;if(u<i){let e=i-u;f.pos.y+=e,f.vel.y=Math.abs(f.vel.y)*t,f.vel.x*=.95,f.angVel+=(l-f.pos.x)*f.vel.y*1e-4}if(l>o){let e=l-o;f.pos.x-=e,f.vel.x=-Math.abs(f.vel.x)*t,f.angVel+=(u-f.pos.y)*-f.vel.x*1e-4}if(l<-o){let e=-o-l;f.pos.x+=e,f.vel.x=Math.abs(f.vel.x)*t,f.angVel+=(u-f.pos.y)*f.vel.x*1e-4}if(!p.isActive){let e=x*2;S*2;let t=e*a.uBNotchWRatio.value;Math.abs(l)<t*.5&&Math.abs(u-E)<20&&(p.isActive=!0,p.shouldSnapToAnchor=!1,p.vel.addScaledVector(f.vel,.8),p.angVel=(Math.random()-.5)*10,p.vel.y-=200,f.vel.y*=-.5,f.angVel+=(Math.random()-.5)*5)}}}if(p.isActive){p.vel.y+=e*r,p.pos.addScaledVector(p.vel,r),p.rot+=p.angVel*r,-v*.5-200;let t=c*.5-5;(p.pos.x>t||p.pos.x<-t)&&(p.vel.x*=-.8)}let i=(t,n)=>{if(t.isActive){t.vel.y+=e*r,t.pos.addScaledVector(t.vel,r),t.rot+=t.angVel*r;let n=-v*.5,i=c*.5;t.pos.y<n&&(t.pos.y=n,t.vel.y=Math.abs(t.vel.y)*.6,t.vel.x*=.9,t.angVel*=.9),(t.pos.x>i||t.pos.x<-i)&&(t.vel.x*=-.8)}};i(m,0),i(h,1)}let D=a.uCutSize.value,O=new e.Vector2(x,S),k=S*2,A=(x*2-D*2)*a.uIslToMainWRatio.value,j=k*a.uIslBarHeightRatio.value,M=k*a.uIslBarGapRatio.value,N=k*a.uIslBarMarginLeftRatio.value,P=k*a.uIslBarMarginRightRatio.value,ee=k*a.uIslBarMarginYRatio.value,te=e=>{let t=O.y-D-ee-ne(e)*(j+M)-j*.5,n=t-O.y;return{x:(-O.x+N+n+(-O.x+A+n-P))*.5,y:t}},ne=e=>e;if(!m.isActive){let e=te(0);m.pos.set(e.x,e.y),m.rot=0}if(a.uIslBar1Pos.value.copy(m.pos),a.uIslBar1Rot.value=m.rot,!h.isActive){let e=te(1);h.pos.set(e.x,e.y),h.rot=0}a.uIslBar2Pos.value.copy(h.pos),a.uIslBar2Rot.value=h.rot;let re=o*$.DIAMOND_ROT_SPEED;a.uDiamondRot.value.set(Math.cos(re),Math.sin(re));let ie=a.uCutSize.value,F=(c-y*2-ie*2)*a.uIslToMainWRatio.value,ae=v-b,I=y,oe=I+F+ie+20,se=S*2,L=$.ISL_BAR_MARGIN_Y_RATIO,ce=$.ISL_BAR_HEIGHT_RATIO,le=$.ISL_BAR_GAP_RATIO,R=$.CORNER_RADIUS,ue=ie+se*(L*2+2*ce+1*le)-R,de=ae-ue-20;if(t.points&&t.points.material&&t.points.material.uniforms.uMaskRect){t.points.material.uniforms.uMaskRect.value.set(I,de,oe,ae);let e=I+F,n=ae;t.points.material.uniforms.uMaskSlant&&t.points.material.uniforms.uMaskSlant.value.set(e,n);let r=ue+$.CORNER_RADIUS,i=a.uNavGap?a.uNavGap.value:$.TL_GAP,o=a.uNavigatorVisibility?a.uNavigatorVisibility.value:1,s=0,l=a.uNavVis.value,u=a.uNavWH.value;for(let e=0;e<6;e++)l[e]>.01&&u[e]>.01&&(s+=r*u[e]+i);s>0&&(s-=i),s*=o;let d=c-y+$.CORNER_RADIUS+20,f=c-y+$.CORNER_RADIUS-s-i,p=v-b+$.CORNER_RADIUS+20,m=v-b+$.CORNER_RADIUS-ue-i;t.points.material.uniforms.uMaskRectNav&&t.points.material.uniforms.uMaskRectNav.value.set(f,m,d,p)}let fe=S*2*a.uBNotchHRatio.value,pe=-S+fe;a.uPosStart.value.set(0,pe),a.uPosHead.value.set(0,pe);let me=a.uVerticalMarginPct.value,he=a.uCutSize.value,ge=a.uIslToMainWRatio.value,_e=me>=.5,z=s._lastVMargin!==me||s._lastCutSize!==he||s._lastIslW!==ge||s._lastResX!==c||s._lastResY!==v;if(_&&z&&!_e){let e=y,t=b,n=S*2,r=n*a.uIslBarHeightRatio.value,o=n*a.uIslBarGapRatio.value,l=n*a.uIslBarMarginLeftRatio.value,u=n*a.uIslBarMarginYRatio.value,d=a.uCutSize.value;s._labelGroups&&s._labelGroups.forEach((n,i)=>{let a=t+d+u+i*(r+o)+r*.5,s=t-a,c=e+l+s,f=r*1.6;n.style.height=`${r}px`,n.style.fontSize=`${f}px`,n.style.transform=`translate(${c-20}px, ${a}px) translate(-100%, -50%)`;let p=n.querySelector(`.hud-label-text`);if(p){let t=c-e-25;p.style.maxWidth=`${t}px`}}),s._lastVMargin=me,s._lastCutSize=d,s._lastIslW=ge,s._lastResX=c,s._lastResY=v,i()}if(s._navLabelGroups&&a.uNavCount&&a.uNavCount.value>0&&!_e){let e=a.uNavGap?a.uNavGap.value:$.TL_GAP,t=S*2,n=a.uIslBarMarginYRatio.value*2+2*a.uIslBarHeightRatio.value+1*a.uIslBarGapRatio.value,r=$.CORNER_RADIUS,i=he+t*n+r,o=b-r,l=c-y+r,u=i*.32,d=0;s._navLabelGroups.forEach((t,n)=>{let r=a.uNavVis.value[n],s=a.uNavWH.value[n],c=i*s,f=a.uNavigatorVisibility?a.uNavigatorVisibility.value:1,p=r>.001&&s>.001&&f>.001,m=c*.02,h=l-d-c*.5+m,g=o+i*.5;t.style.left=`0`,t.style.top=`0`,t.style.width=`${c}px`,t.style.height=`${i}px`,t.style.fontSize=`${u}px`,t.style.transform=`translate(${h}px, ${g}px) translate(-50%, -50%)`,t.style.opacity=r*f,t.style.display=p?`flex`:`none`,p&&(d+=c+e)})}};let _=(()=>{let e=document.createElement(`div`);e.className=`hud-island-labels`,e.innerHTML=`
...
`}));async function fc(t,n){if(n&&B(window.loadingProgress||0,z(`SYS_PHYSICS_CALC`)),!t.world&&(console.warn(`Physics world not ready, waiting...`),await new Promise(e=>setTimeout(e,100)),!t.world))throw Error(`Physics World not initialized`);t.bhTargets||=[];let r=new Map;t.traverse(e=>{e.name&&r.set(e.name,e)});async function i(e,n,i={}){let a=Array.isArray(e)?e:[e],o=0,s=performance.now();for(let e of a){let c=r.get(e);if(!c)continue;i.isBhTarget&&t.bhTargets.push(c),c.visible=!1,(i.isConvexHull||performance.now()-s>1)&&(await Mr(),s=performance.now());let l=n(t,c,i);be(t,c,l.body,l.shape,i),o++,a.length>5&&Fe(`physics-binding`,.1+o/a.length*.7)}}await i([`backWall_rapier`,`rightWall`,`leftWall`,`glass2`,`frontWall`,``,`Object_15`,`Object_15001`,`Cube004`,`Cube019_3`,`Cube019_5`,`Object_1001_1`,`Object_8001`,`leftWallFoot001`,`Object_38001`],Se,{bodyType:`fixed`,restitution:.4,friction:.4}),await i([`bedMain`,`bedStand`],Se,{bodyType:`fixed`,restitution:.1,friction:.4,isConvexHull:!0}),Fe(`physics-binding`,.2,z(`SYS_MAPPING_BOUNDARIES`));let a=r.get(`a-char`);if(a){Fe(`physics-binding`,.3,z(`SYS_CHAR_COLLISION`)),new e.Quaternion().setFromAxisAngle(new e.Vector3(1,0,0),Math.PI/2);let n=b.ColliderDesc.capsule(.48,.66).setTranslation(0,.1,0);xe(t,a,t.world.createRigidBody(b.RigidBodyDesc.kinematicPositionBased()),n,{trackBoneName:`mixamorigSpine1`,offset:new e.Vector3(0,0,0),restitution:.5,friction:.4,softKinematic:.7}),Fe(`physics-binding`,.4,z(`SYS_BINDING_ARMATURES`)),[{bone:`mixamorigLeftArm`,shapeType:`capsule`,radius:.2,height:.4,offset:new e.Vector3(0,.35,0)},{bone:`mixamorigRightArm`,shapeType:`capsule`,radius:.2,height:.4,offset:new e.Vector3(0,.35,0)},{bone:`mixamorigLeftForeArm`,shapeType:`capsule`,radius:.2,height:.3,offset:new e.Vector3(0,.5,0)},{bone:`mixamorigRightForeArm`,shapeType:`capsule`,radius:.2,height:.3,offset:new e.Vector3(0,.5,0)},{bone:`mixamorigLeftUpLeg`,shapeType:`capsule`,radius:.3,height:.4,offset:new e.Vector3(0,1,0)},{bone:`mixamorigRightUpLeg`,shapeType:`capsule`,radius:.3,height:.4,offset:new e.Vector3(0,1,0)},{bone:`mixamorigRightLeg`,shapeType:`capsule`,radius:.3,height:.4,offset:new e.Vector3(0,1,0)},{bone:`mixamorigLeftFoot`,shapeType:`capsule`,radius:.24,height:.15,offset:new e.Vector3(0,.5,0)},{bone:`mixamorigRightFoot`,shapeType:`capsule`,radius:.24,height:.15,offset:new e.Vector3(0,.5,0)},{bone:`mixamorigHead`,shapeType:`ball`,radius:.43,offset:new e.Vector3(0,.35,0)}].forEach(e=>{let n;n=e.shapeType===`ball`?b.ColliderDesc.ball(e.radius):b.ColliderDesc.capsule(e.height,e.radius),e.offset&&n.setTranslation(e.offset.x,e.offset.y,e.offset.z),e.rotation&&n.setRotation(e.rotation),xe(t,a,t.world.createRigidBody(b.RigidBodyDesc.kinematicPositionBased()),n,{trackBoneName:e.bone,restitution:.5,friction:.4,softKinematic:.7})})}else console.warn(`bindPhysics: Character 'a-char' not found.`);Fe(`physics-binding`,.5,z(`SYS_ANCHORING_ROTORS`));for(let e of[`cFanBody`]){let n=r.get(e);if(n){let{body:e,shape:r}=Se(t,n,{bodyType:`kinematicPosition`});xe(t,n,e,r,{restitution:.2,friction:.9,softKinematic:.7})}}await i(`glassInvi`,Se,{bodyType:`kinematicPosition`}),await i(`stool_bound`,Se,{bodyType:`kinematicPosition`,isIntegrityResetTarget:!0,isIntegrityCheckTarget:!0,isConvexHull:!0,restitution:.7,friction:.2}),Fe(`physics-binding`,.6,z(`SYS_DYNAMIC_RIGIDBODIES`)),await i(`Object_31`,Se,{bodyType:`dynamic`,restitution:.2,mass:10,pullingDampness:.25,canSleep:!0,isBhTarget:!0,isConvexHull:!0,isIntegrityCheckTarget:!0}),await i(`pictureLionFrame`,Se,{bodyType:`dynamic`,mass:1,pullingDampness:.0025,canSleep:!0,isBhTarget:!0,isConvexHull:!0,isIntegrityCheckTarget:!1,isIntegrityResetTarget:!0}),await i(`Model_0001`,Se,{bodyType:`dynamic`,mass:1.5,restitution:.01,friction:.995,pullingDampness:.0025,canSleep:!0,isBhTarget:!0,isConvexHull:!0,isIntegrityResetTarget:!0,isIntegrityCheckTarget:!1}),await i(`blackCat`,Ce,{bodyType:`fixed`,scale:new e.Vector3(1,1,.5),offset:new e.Vector3(0,.5,0)}),Fe(`physics-binding`,.7,z(`SYS_BONE_HIERARCHIES`));let o=r.get(`GLTF_created_0001`);if(o){let n=b.ColliderDesc.capsule(.2,.15).setTranslation(0,0,0);xe(t,o,t.world.createRigidBody(b.RigidBodyDesc.kinematicPositionBased()),n,{trackBoneName:`Root_M_2_6_11`,offset:new e.Vector3(0,0,0),restitution:.2,friction:.9,softKinematic:.7}),[{bone:`HipFix_R_3_7_12`,shapeType:`ball`,radius:.1,offset:new e.Vector3(0,0,0)},{bone:`HipFix_L_85_89_94`,shapeType:`ball`,radius:.1,offset:new e.Vector3(0,0,0)},{bone:`RootPart1_M_16_20_25`,shapeType:`capsule`,radius:.4,height:.3,offset:new e.Vector3(0,.2,.2)},{bone:`Tail0_M_10_14_19`,shapeType:`capsule`,radius:.05,height:.2,offset:new e.Vector3(0,0,0)},{bone:`Tail20_M_15_19_24`,shapeType:`capsule`,radius:.05,height:.2,offset:new e.Vector3(0,0,0)},{bone:`Head_M_26_30_35`,shapeType:`ball`,radius:.3,offset:new e.Vector3(0,0,0)}].forEach(e=>{let n;n=e.shapeType===`ball`?b.ColliderDesc.ball(e.radius):b.ColliderDesc.capsule(e.height,e.radius),e.offset&&n.setTranslation(e.offset.x,e.offset.y,e.offset.z),xe(t,o,t.world.createRigidBody(b.RigidBodyDesc.kinematicPositionBased()),n,{trackBoneName:e.bone,restitution:.2,friction:.9,softKinematic:.7})})}await i(`Object_2001`,Se,{bodyType:`dynamic`,mass:80,restitution:.6,canSleep:!0,isBhTarget:!0,isConvexHull:!0,offset:new e.Vector3(0,0,0),pullingDampness:.45,isIntegrityCheckTarget:!0}),await i(`mjolnir_low_mjolnir_hammer_0`,Se,{bodyType:`dynamic`,mass:10,restitution:0,canSleep:!0,isBhTarget:!0,pullingDampness:.9075,isConvexHull:!0,isIntegrityResetTarget:!0}),await i(`questionCube`,Ce,{bodyType:`dynamic`,mass:20,isBhTarget:!0,isIntegrityResetTarget:!0}),await i(`shelf`,Se,{bodyType:`dynamic`,mass:400,restitution:.3,canSleep:!0,isBhTarget:!0,pullingDampness:.25,isIntegrityCheckTarget:!1,isIntegrityResetTarget:!0});let s=[];for(let e=0;e<=38;e++){let t=`book`+String(e).padStart(3,`0`);s.push(t)}await i(s,Ce,{bodyType:`dynamic`,isBhTarget:!0,mass:2,restitution:.05,canSleep:!0,pullingDampness:.25,isIntegrityCheckTarget:!1,isIntegrityResetTarget:!0}),await i([`pokeball`,`pokeball2`],we,{bodyType:`dynamic`,mass:27,scale:.425,restitution:.9,isBhTarget:!0,isIntegrityResetTarget:!0}),await i(`drone`,Ce,{bodyType:`kinematicPosition`,mass:2.5,isBhTarget:!1,linearDamping:1,angularDamping:1}),Fe(`physics-binding`,.85,z(`SYS_COLLISION_MESHES`));try{await i(`caseCover`,Ce,{bodyType:`dynamic`,mass:100,restitution:.1,isBhTarget:!0,isIntegrityCheckTarget:!0}),await i(`Object_42001`,Ce,{bodyType:`dynamic`,mass:.5,restitution:.93,canSleep:!0,isBhTarget:!0,pullingDampness:-1,isIntegrityResetTarget:!0}),await i(`screenDisplay`,Ce,{bodyType:`dynamic`,mass:200,scale:new e.Vector3(1,1.05,.9),offset:new e.Vector3(0,-.13,0),isBhTarget:!0,pullingDampness:.5,isIntegrityCheckTarget:!0}),await i(`screenDisplay2`,Ce,{bodyType:`dynamic`,mass:20,scale:new e.Vector3(1,1.05,.9),offset:new e.Vector3(0,-.13,0),isBhTarget:!0,pullingDampness:.15,restitution:.3,isIntegrityCheckTarget:!0}),await i(`verticalMonitor`,Ce,{bodyType:`dynamic`,mass:150,friction:.9,scale:new e.Vector3(1,1,1),offset:new e.Vector3(0,1.75,0),isBhTarget:!0,pullingDampness:.25,isIntegrityCheckTarget:!0}),await i([`aegis`,`aegis2`],Se,{bodyType:`dynamic`,mass:1.1,restitution:.01,canSleep:!0,isBhTarget:!0,isConvexHull:!0,isIntegrityResetTarget:!0}),await i([`pillow-small-1`,`pillow-small-2`,`pillow-big-1`,`pillow-big-2`],Se,{bodyType:`dynamic`,mass:100.3,restitution:0,friction:.9,canSleep:!0,pullingDampness:.64,isBhTarget:!0,isConvexHull:!0,isIntegrityResetTarget:!0})}catch(e){throw e}}var pc=P((()=>{Ae(),tt(),Nr(),ve()})),mc=P((()=>{un(),Tt(),qn()}));function hc(t,n){if(!t||!n)return console.error(`initConversationBox: Missing model or scene`),null;let r=null;if(t.traverse(e=>{e.isBone&&e.name===`mixamorigSpine2`&&(r=e)}),r||t.traverse(e=>{e.isBone&&e.name===`mixamorigSpine`&&(r=e)}),r||t.traverse(e=>{e.isBone&&e.name===`mixamorigHips`&&(r=e)}),r||=t.getObjectByName(`Ch23_Hair`),!r)return console.warn(`initConversationBox: No head found.`),null;let i=null,a=0,o=0,s=null;new e.Vector2;function c(){if(document.getElementById(`scifi-shout-box`))return;i=document.createElement(`div`),i.id=`scifi-shout-box`,Object.assign(i.style,{position:`absolute`,top:`0`,left:`0`,pointerEvents:`none`,zIndex:`5000`,padding:`10px 20px`,color:`#ffffff`,fontFamily:`"Rajdhani", sans-serif`,fontWeight:`600`,fontSize:`18px`,textAlign:`center`,display:`flex`,alignItems:`center`,justifyContent:`center`,lineHeight:`1.4`,backgroundColor:`rgba(5, 10, 25, 0.85)`,backdropFilter:`blur(10px)`,border:`1.5px solid #00F0FF`,boxShadow:`0 0 30px rgba(0, 240, 255, 0.25)`,opacity:`0`,whiteSpace:`pre-wrap`,transform:`translate(-50%, -100%) scale(0.8)`,transition:`opacity 0.3s ease, transform 0.3s cubic-bezier(0.175, 0.885, 0.32, 1.25)`,letterSpacing:`1px`,textTransform:`none`,borderRadius:`2px`,clipPath:`none`});let e=document.createElement(`div`);Object.assign(e.style,{position:`absolute`,bottom:`-7.5px`,left:`50%`,width:`12px`,height:`12px`,backgroundColor:`rgba(5, 10, 25, 0.95)`,borderLeft:`1.5px solid #00F0FF`,borderBottom:`1.5px solid #00F0FF`,transform:`translateX(-50%) rotate(-45deg)`,zIndex:`1`}),i.appendChild(e);let t=document.createElement(`div`);Object.assign(t.style,{position:`absolute`,bottom:`4px`,right:`4px`,width:`8px`,height:`8px`,borderRight:`2px solid #00F0FF`,borderBottom:`2px solid #00F0FF`}),i.appendChild(t),document.getElementById(`experience-container`).appendChild(i)}function l(e,t={}){i||c();let n=e;Array.isArray(e)&&(n=e[Math.floor(Math.random()*e.length)]);let r=i.querySelector(`.text-content`);r||(r=document.createElement(`span`),r.className=`text-content`,i.insertBefore(r,i.firstChild)),r.innerText=n;let a=1;t.extraSmall?a=.56:t.small&&(a=.65),i.style.fontSize=`${18*a}px`,i.style.minWidth=n.length>20?`160px`:`95px`}c();let u={update:t=>{if(i){if(Math.abs(o-a)>.01){let e=3*t;o=o<a?Math.min(o+e,a):Math.max(o-e,a),i.style.opacity=o,i.style.display=o>.01?`block`:`none`}else i.style.opacity=a,i.style.display=a>.01?`block`:`none`;if(a>.01&&r&&n.camera&&n.renderer){let t=new e.Vector3;r.getWorldPosition(t),t.y+=2,t.project(n.camera);let a=n.renderer.domElement,s=a.clientWidth/2,c=a.clientHeight/2,l=t.x*s+s,u=-(t.y*c)+c,d=.8+.2*o;i.style.transform=`translate(-50%, -100%) translate(${l}px, ${u}px) scale(${d})`}}},updateText:(e,t={})=>{l(e,t)},show:()=>{a=1,i&&(i.style.display=`block`)},hide:()=>{a=0},shout:(e,t=3e3,n={})=>(s&&clearTimeout(s),l(e,n),u.show(),s=setTimeout(()=>{u.hide(),s=null},t),s),clear:()=>{s&&=(clearTimeout(s),null),a=0,o=0,i&&(i.style.opacity=`0`,i.style.display=`none`)}};return u}var gc=P((()=>{}));function _c(t){let n=t.getObjectByName(`Blackhole`);if(!n)return;n.position.y=-500,n.scale.setScalar(2),n.traverse(t=>{t.isMesh&&t.material&&(t.material.roughness=.95,t.material.metalness=0,t.material.side=e.FrontSide,t.castShadow=!1)});function r(e,t,r){let i=n.getObjectByName(e);i?.material&&i.material[t]!==void 0&&(i.material[t]=r)}r(`Lathe_L_Blackhole_03_0`,`roughness`,.4),r(`Lathe_S_Blackhole_01_0`,`metalness`,.6);let i=n.getObjectByName(`Lathe_Center`);if(i){let n=t.globalUniformsHub;n&&n.core,i.material=new e.ShaderMaterial({vertexShader:Bt,fragmentShader:qt,transparent:!0,uniforms:{...n.uniforms,nebulaCoreRadius:{value:20},nebulaTwistFactor:{value:0},alpha:{value:1}},blending:e.AdditiveBlending,name:`nebulaMat`})}}function vc(t){let n=t.globalUniformsHub,r=n?n.uniforms:{},i=Pr(t,Jt,{side:e.BackSide,uniforms:{...n.core,isStriking:r.isStriking||{value:!1},normalizedStrikePos:r.normalizedStrikePos||{value:new e.Vector2(-2,-2)},uRainHeaviness:r.uRainHeaviness||{value:2},uStormSharpness:r.uStormSharpness||{value:0},uMoonPosition:r.uMoonPosition||{value:new e.Vector2(.58,.705)},uMoonSize:r.uMoonSize||{value:.006},uMoonBrightness:r.uMoonBrightness||{value:2.5},uMoonBlur:r.uMoonBlur||{value:0},uCraterScale:r.uCraterScale||{value:.555},uCraterIntensity:r.uCraterIntensity||{value:.28},uFarMountainOffset:r.uFarMountainOffset||{value:0},uNearMountainOffset:r.uNearMountainOffset||{value:-.5}}}),a=new e.Mesh(Kn.plane,i);t.add(a),a.position.set(-55,-20,30),a.scale.setScalar(150),a.name=`planeSky`,a.visible=!1}function yc(t){let n=t.globalUniformsHub,r=n?n.uniforms:{},i=Pr(t,Yt,{transparent:!0,uniforms:{rainGlassOpacity:r.rainGlassOpacity||{value:1},glassRainAmount:r.glassRainAmount||{value:1},uRimCenter:r.uRimCenter||{value:new e.Vector2(-.5,.5)},uRainOffset:r.uRainOffset||{value:0},uWaterIntensity:n&&n.uWaterIntensity||{value:.2},hasRimOnGlass:{value:!0}},blending:e.AdditiveBlending,side:e.FrontSide}),a={vertexShader:i.vertexShader,fragmentShader:i.fragmentShader,uniforms:i.uniforms};Sr(a,i.uniforms),i.vertexShader=a.vertexShader,i.fragmentShader=a.fragmentShader;let o=t.getObjectByName(`glass1`),s=t.getObjectByName(`glass2`);o&&(o.material=i),s&&(s.material=i)}var bc,xc=P((()=>{tt(),nt(),qn(),Tt(),Xs(),An(),ac(),un(),dc(),Ae(),Ja(),Zr(),pc(),rc(),mc(),kr(),Qo(),gc(),Nr(),ve(),Et(`#dcd0ba`,.85,.03,6.5),Dt(`#dcd0ba`,1,1),bc=class{constructor(e,t,n,r){this.scene=e,this.camera=t,this.renderer=n,this.model=null,this.mixer=null,this.constantUniform=wt,this.resources=r}async init(t,n,r={}){return new Promise(async(n,r)=>{let i=this.resources.roomModel;if(!i){let e=`Resources: Room Model not loaded.`;console.error(e),t&&B(window.loadingProgress||0,z(`SYS_ERROR`)),r(e);return}try{t&&B(window.loadingProgress||0,z(`SYS_INIT_SCENE`)),Fe(`model-assembly`,.1),this.model=i.scene,this.model.name=`roomGLBModel`,this.model.visible=!1,this.scene.add(this.model),this.scene.room=this.model,this.scene.animations=i.animations,this.boxUpdater=hc(this.model,this.scene),this.scene.conversationManager=this.boxUpdater;let a=[`leftWallFoot001`,`Cube004`,`shelf`,`glass1`,`Object_17`,`Object_1001_1`,`Object_8001`,`glass1`,`pillow-big-2`,`pillow-small-2`,`pillow-small-1`,`pillow-big-1`,`bedMain`,`Ch23_Hair`,`Ch23_Suit`,`Object_15`],o=[`Object_1001_1`,`Object_8001`,`Object_17`,`leftWallFoot001`];this.model.getObjectByName(`inviMesh`).material.visible=!1;let s=[this.model],c=0,l=performance.now();for(;s.length>0;){let t=s.pop();if(t.isMesh&&(t.material.side=e.FrontSide,a.includes(t.name)&&(t.receiveShadow=!0),o.includes(t.name)||t.name.startsWith(`book`)?t.castShadow=!1:t.castShadow=!0),t.children)for(let e=t.children.length-1;e>=0;e--)s.push(t.children[e]);c++,c%50==0&&performance.now()-l>4&&(await Mr(),l=performance.now())}if(this.mixer=i.mixer,this.scene.mixer=i.mixer,this.scene.heroClips=i.heroClips,this.scene.activeAction=i.activeAction,this.mixer&&this.scene.animations){let t=e.AnimationClip.findByName(this.scene.animations,`3|PlaneAction`);t&&(this.scene.fanAction=this.mixer.clipAction(t),this.scene.fanAction.play())}V.start(`Helpers Setup`),Ks(this.scene),_c(this.scene),vc(this.scene),yc(this.scene),Cn(this.scene),ic(this.scene);let u=oc(this.scene);this.scene.getObjectByName(`blackholeScene`).attach(u),V.end(`Helpers Setup`),V.start(`Adjust Objects`),Fr(this.scene,t).then(()=>(V.end(`Adjust Objects`),V.start(`Bind Physics`),fc(this.scene,t))).then(async()=>(V.end(`Bind Physics`),Fe(`physics-binding`,.9),await Ir(this.scene),Fe(`physics-binding`,1),wa(this.scene),this.scene.constantUniform=wt,t&&B(window.loadingProgress||0,z(`SYS_FINALIZE`)),Promise.resolve())).then(()=>{B(100),clearInterval(void 0),this.model&&this.model.position.set(0,-5e4,0),n()}).catch(e=>{console.error(`Critical error in async chain:`,e),r(e)})}catch(e){console.error(`Critical error during scene initialisation:`,e),r(e)}finally{window.completeTask&&(completeTask(`model-assembly`),completeTask(`physics-binding`))}})}updateAnimationMixer(e){this.mixer&&this.mixer.update(e),this.boxUpdater&&this.boxUpdater.update(e)}}}));async function Sc({scene:e,camera:t,orbitControl:n,clock:r,pointsApp:i}){e.targetAnimHz=30,Io(e,0),Do(e,Cc*.05),Z(z(`SYS_INIT`)),Z(z(`ENV_CALIBRATION`)),await bo(),Z(z(`SYS_PILOT_ENTRY_WAIT`)),await xo(),await So(200),e.isTransitioning=!0,e.HUD&&typeof e.HUD.breathe==`function`&&e.HUD.breathe(R.ELECTRIC_CYAN);let a=Q.currentMode;e.fpsStats&&e.fpsStats.avg<45&&(e.isLowPowerMode=!0),Z(`Protocol ${a.toUpperCase()} verified.`);let o=document.getElementById(`cv-container`);o&&o.classList.contains(`collapsed`)&&(o.classList.remove(`collapsed`),window.dispatchEvent(new CustomEvent(`cvToggle`,{detail:{collapsed:!1}})),await So(500)),e.HUD&&typeof e.HUD.runTweenOpen==`function`&&(await e.HUD.runTweenOpen(1500,{isIncludedIsland:!1,isIncludedDecos:!1}),e.HUD.runTweenShowIsland(2500),eo.onHudOpen(e),e.HUD.runTweenShowDecos(1e3)),i&&(i.playIntro(),i.activateScrollInteractions(),i.triggerStep&&i.triggerStep(0,1500,!0)),Z(z(`SYS_BUILD_START`)),setTimeout(()=>{e.isTransitioning=!1},1e3)}var Cc,wc=P((()=>{Qo(),Ss(),vs(),ve(),lr(),Ja(),me(),to(),Cc=Go}));function Tc(t,n){if(!t)return console.warn(`[knowhere] Parent not found. Skipping.`),null;let r=new e.PlaneGeometry(1,1),i=Pr(n,Dc,{transparent:!0,blending:e.NormalBlending,side:e.DoubleSide,depthTest:!0,depthWrite:!1,vs:Ec});i.uniforms&&(i.uniforms.uScaleFactor={value:0},i.uniforms.uHudOffset={value:new e.Vector2(0,1.2)},i.uniforms.uStarScreenPos={value:new e.Vector2(0,0)});let a=new e.Mesh(r,i);return a.name=`knowhere`,a.scale.set(10,10,1),a.frustumCulled=!1,t.add(a),n.knowhere=a,a}var Ec,Dc,Oc=P((()=>{Zr(),Tt(),Ec=`
    varying vec2 vUv;
